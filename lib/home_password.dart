...
class _HomePasswordState extends State<HomePassword> {
  ...
  int calculateColumnCount(double screenWidth) {
    int columnCount = 2; // Default column count for narrow screens
    if (screenWidth > 600) {
      columnCount = 3;
    }
    if (screenWidth > 900) {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer: homePasswordDrawer(context),
      body: Center(
          child: Column(
        children: <Widget>[
            ...
            child: ListView.separated(
              ...
              itemBuilder: (BuildContext context, int index) {
                return ExpansionTile(
                  ...
                  trailing: itemTrailerMenu(index, context),
                );
              },
      ...
      floatingActionButton: floatBucton(context),
      floatingActionButtonLocation: FloatingActionButtonLocation.centerFloat,
    );
  }

  FloatingActionButton floatBucton(BuildContext context) {
          ...
          if (_controllerApp.text.isEmpty) {
            ...
            if (snapshot.exists) {
              await ref.update({
                ...
                "update_time_unix":
                    (createTime.toUtc().millisecondsSinceEpoch / 1000).round(),
              });
            } else {
              try {
                await ref.set({
  ...
  PopupMenuButton<String> itemTrailerMenu(int index, BuildContext context) {
  ...
  Drawer homePasswordDrawer(BuildContext context) {
    return Drawer(
      child: ListView(
        children: <Widget>[
